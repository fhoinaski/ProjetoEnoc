...
const Section = () => {
  return (
    <div className='p-2 md:p-3  w-full h-44 md:h-auto  bg-green-100'>
      ...
      {/* <button className="bg-secondary hover:bg-btn_primary rounded-full px-10 py-1 absolute z-10 top-48 mx-auto md:mx-0 left-0 right-0 text-gray-900 md:right-60 md:top-44 xl:right-1/3 xl:top-48">Aproveite agora</button>
 */}
      <button className="bg-secondary hover:bg-btn_primary rounded-full px-10 py-1 absolute z-10 top-48 mx-auto md:mx-0 left-10 right-10 md:left-auto text-gray-900 md:right-60 md:top-44 xl:right-1/3 xl:top-48">Aprovite agora</button>
